...
SWEP.PrintName = "海洛因针筒"
SWEP.Instructions	= "海伦因针筒, 在其他名称中也被称为二吗啡, 是一种鸦片类药物, 因其具有快感作用而被用作娱乐性药物。海洛因是用罂粟花的奶制成的.\n\n左键注射药物. 如果你是杀手你可以注射到别人身上"
SWEP.Author			= ""
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.BobScale=2
...
function SWEP:AttackFront()
	...
	timer.Simple(75,function()
		...
		if((IsValid(Ent))and(Ent:Alive())and(Ent.LifeID==LifeID))then
			...
			self.Owner:PrintMessage(HUD_PRINTCENTER,"必须从背后下手!")
		end
	else
